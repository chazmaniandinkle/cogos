// modality_types.go — Go interfaces for modality modules.
//
// Defines the Gate/Decoder/Encoder pattern for the modality bus.
// Each modality module (text, voice, vision, spatial) implements
// ModalityModule to participate in the sensorimotor boundary.
//
// Translated from the Python POC (mod3/modality.py) into idiomatic Go.
// Bus orchestration runs in Go; Python subprocesses handle inference.
...
const (
	...
	ModalityVision  ModalityType = "vision"
	ModalitySpatial ModalityType = "spatial"
)
...
const (
	...
	ModuleStatusCrashed  ModuleStatus = "crashed"
)
...
// ModalityModule is the full module contract. Each sensory modality
// (text, voice, vision, spatial) implements this interface to
// participate in the modality bus.
type ModalityModule interface {
